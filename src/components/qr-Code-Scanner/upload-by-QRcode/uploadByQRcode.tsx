  ...
  return (
    <div className="min-h-screen bg-gray-100 flex flex-col items-center justify-center p-4">
      <div className="bg-white rounded-lg shadow-lg p-6 w-full max-w-md">
        ...
        {/* Success - Show Download and Copy Options */}
        {convertedPdfUrl && (
          <div className="bg-green-100 border border-green-400 text-green-700 px-4 py-3 rounded">
            <p className="font-semibold mb-4">PDF Converted Successfully!</p>
            <div className="flex flex-col gap-2">
              ...
              <button
                onClick={() => {
                  navigator.clipboard.writeText(convertedPdfUrl);
                  alert('URL copied to clipboard!');
                }}
                className="w-full bg-gray-600 hover:bg-gray-700 text-white font-semibold py-2 px-4 rounded text-sm"
              >
                Copy URL
              </button>
            </div>
