...
const PdfToXls = () => {
    const words = ["Better", "PDF", "Perfect", "XLS"];
    ...
    const convertPdfToXls = async (fileUrl: string) => {
        setState('converting');
    ...
    return (
        <div className="min-h-[calc(100vh-65px)] bg-[#fff9f6]   flex flex-col items-center  justify-start">
            ...
            <div className='pb-10'>
                ...
                <p className="text-muted-foreground text-lg">Convert your PDF images to high-quality XLS documents</p>
                    ...
                    <div className="space-y-6">
                        ...
                        {state === 'converting' && (
                            <div className="flex flex-col items-center space-y-4">
                                ...
                                <p className="text-muted-foreground">Converting PDF to XLS.....</p>
                            </div>
                        )}
