  ...
  return (
    <div className="min-h-[calc(100vh-65px)] bg-[#fff9f6] flex flex-col items-center justify-start">
      ...
      <div className='pb-10 flex flex-col justify-center items-center'>
        ...
        <p className="text-muted-foreground text-lg">JPG to JSON Converter</p>
        <p className="text-[#a855f7] text-sm mt-2 font-medium">
          Convert JPG/JPEG images into JSON format with structured data extraction.
        </p>
      </div>
          ...
          <div className="space-y-6">
            {state === 'select' && !uploadedFileUrl && (
              ...
              >
                ...
                <h3 className="text-xl font-semibold text-white">Choose JPG File</h3>
                <input
                  ref={fileInputRef}
                  type="file"
