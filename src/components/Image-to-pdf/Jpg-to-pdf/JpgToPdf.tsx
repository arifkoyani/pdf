    ...
    return (
        <div className="min-h-[calc(100vh-65px)] bg-[#f5edf0]   flex flex-col items-center  justify-start">
            ...
            <div className='pb-10'>
                ...
                <p className="text-muted-foreground text-lg">Convert your Jpg or Jpeg images to high-quality PDF documents</p>
                <p className="text-center bg-[#FEEDE5] text-yellow-800  px-4 py-2 mt-4">
                    📌 JPG and JPEG are the same format — this tool supports both.
                </p>
