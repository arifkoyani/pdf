...
const CsvToHtml = () => {
  const words = ["csv", "Spreadsheet", "Data", "Conversion"];
  ...
  const convertCsvToHtml = async (file: File) => {
    setState("uploading");
    ...
    <div className="min-h-[calc(100vh-65px)] bg-[#fff9f6] flex flex-col items-center justify-start">
      ...
      <div className="pb-10">
        ...
        <p className="text-muted-foreground text-lg">
          Upload your Csv file  and convert it to Html format
        </p>
      </div>
          ...
          {state === "ready" && convertedFileUrl && (
            <div className="space-y-6">
              <div className="bg-white p-6 rounded-lg shadow-md space-y-4">
                ...
                <p className="text-gray-600">Your CSV file has been successfully converted to Html format.</p>
