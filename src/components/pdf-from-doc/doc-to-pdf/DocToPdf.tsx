...
const DocToPdfConverter = () => {
    const words = ["Better", "Docx", "Perfect", "Doc"];
    ...
    const convertDocToPdf = async (fileUrl: string) => {
        setState('converting');
    ...
    return (
        <div className="min-h-[calc(100vh-65px)] bg-[#fff9f6]   flex flex-col items-center  justify-start">
            ...
            <div className='pb-10'>
                ...
                <p className="text-muted-foreground text-lg">Convert your DOC/DOCX files to high-quality PDF documents</p>
                    ...
                    <div className="space-y-6">
                        ...
                        {state === 'converting' && (
                            <div className="flex flex-col items-center space-y-4">
                                ...
                                <p className="text-muted-foreground">Converting DOC/DOCX to PDF.....</p>
                            </div>
                        )}
                        ...
                        {state === 'ready' && (
                            <div className="space-y-4">
                                {convertedFileUrls.map((url, index) => (
                                    <Button
                                        key={index}
                                        onClick={() => downloadFile(url, `converted-doc-${index + 1}.pdf`)}
